# Generated by Powerlevel10k configuration wizard on 2020-04-12 at 12:30 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='tess|kubectl|helm|kubens|kubectx|oc|istioctl|kogito'
